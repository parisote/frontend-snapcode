  ...
  return (
    <div className="d-flex flex-column flex-shrink-0 p-3 text-white bg-black min-vh-100">
      ...
      {(data.userId === ctx.userId) ?
        ...
        :
        (!following) ?
          <Button variant="outline-secondary" className='w-75 mx-3' onClick={() => setFollowing(!following)}>
            Follow
          </Button>
          :
          <Button variant="outline-danger" className='w-75 mx-3' onClick={() => setFollowing(!following)}>
            Unfollow
          </Button>
      }
    </div>
